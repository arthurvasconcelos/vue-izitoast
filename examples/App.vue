    ...
    <form>
      <fieldset>
        ...
        <div>
          ...
          <input type="text" id="which-title" :value="title" @change="(event) => updateCustom('title', event.target.value)">
        </div>
        <div>
          <label for="which-message">Message</label>
          <input type="text" id="which-message" :value="message" @change="(event) => updateCustom('message', event.target.value)">
        </div>
        <div>
          <label for="is-balloon">Show as Balloon?</label>
          <input type="checkbox" id="is-balloon" :checked="balloon" @change="() => updateCustom('balloon', !balloon)">
        </div>
        <div>
          <label for="can-close">Can Close?</label>
          <input type="checkbox" id="can-close" :checked="close" @change="() => updateCustom('close', !close)">
        </div>
        <div>
          <label for="should-close-on-escape">Should close on escape?</label>
          <input type="checkbox" id="should-close-on-escape" :checked="closeOnEscape" @change="() => updateCustom('closeOnEscape', !closeOnEscape)">
        </div>
        <div>
        ...
        <div>
          ...
          <input type="number" id="how-much-timeout" min="0" :value="timeout" @change="(event) => updateCustom('timeout', event.target.value)">
        </div>
        <div>
          <label for="should-animate-inside">Should animate inside?</label>
          <input type="checkbox" id="should-animate-inside" :checked="animateInside" @change="() => updateCustom('animateInside', !animateInside)">
        </div>
        <div>
        ...
        <div>
          ...
          <input type="checkbox" id="pause-on-hover" :checked="pauseOnHover" @change="() => updateCustom('pauseOnHover', !pauseOnHover)">
        </div>
        <div>
          <label for="reset-on-hover">Should reset on hover?</label>
          <input type="checkbox" id="reset-on-hover" :checked="resetOnHover" @change="() => updateCustom('resetOnHover', !resetOnHover)">
        </div>
      </fieldset>
    </form>
    <br/>
